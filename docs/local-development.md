...
```bash
git clone https://github.com/firegroup/research-kit.git
cd spec-kit
...
uvx --from git+https://github.com/firegroup/research-kit.git@your-feature-branch research init demo-branch-test --script ps
```
