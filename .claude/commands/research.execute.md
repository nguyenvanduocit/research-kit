...
**IMPORTANT**: The setup script (`.research/scripts/bash/setup-execution.sh` or `.research/scripts/powershell/setup-execution.ps1`) will automatically:
- Create all necessary directories (`data/raw/`, `data/processed/`, `logs/`, `notebooks/`, `.research/scripts/`)
...
8. **Generate execution artifacts**:
   - Data collection scripts (`.research/scripts/collect_*.py`)
