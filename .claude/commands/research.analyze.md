...
**IMPORTANT**: The setup script (`.research/scripts/bash/setup-analysis.sh` or `.research/scripts/powershell/setup-analysis.ps1`) will automatically:
...
11. **Generate analysis artifacts**:
    ...
    - Analysis scripts (`.research/scripts/analyze_*.py`)
