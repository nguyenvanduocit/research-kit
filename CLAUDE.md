...
- **`templates/`**: Source templates for all generated files
  ...
  - `skills/research/SKILL.md`: SRD workflow orchestrator skill - auto-detects research state and drives workflow forward
...
- Skills: `.claude/skills/<skill-name>/SKILL.md` (folder-based, e.g., `.claude/skills/research/SKILL.md`)
