...
3. Approval by [GOVERNANCE_AUTHORITY] (e.g., project lead, steering committee)
4. Version number incremented per semantic versioning
5. Amendment history documented at end of this document
6. All active research must comply within [COMPLIANCE_WINDOW] (e.g., 30 days)
...
- [REVIEW_FREQUENCY] (e.g., quarterly) review of compliance across projects
...
- All research conducted under [PROJECT_NAME] must adhere to these principles
...
|---------|------|-------------|-------------|
| [PRINCIPLES_VERSION] | [RATIFICATION_DATE] | Initial ratification | [GOVERNANCE_AUTHORITY] |
