...
**IMPORTANT**: The setup script (`.research/scripts/bash/setup-methodology.sh` or `.research/scripts/powershell/setup-methodology.ps1`) will automatically:
...
**DO NOT manually create these directories or files - the script `.research/scripts/bash/setup-methodology.sh` handles everything!**

1. **Run the methodology setup script** `.research/scripts/bash/setup-methodology.sh` which will set up all required files and verify prerequisites
